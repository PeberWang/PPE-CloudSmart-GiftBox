...
from ppe_giftbox.models import CourseDocument, save_json
from ppe_giftbox.config import DATA_DIR, OUTPUT_DIR, DEPLOY_OUTPUT_DIR
...
from ppe_giftbox.services.materials.upload_service import UploadService
from ppe_giftbox.services.core.experience_service import ExperienceService
...
class DocGenerator:
    ...
    def _save_doc_mapping(self, year: str, course_name: str, doc_id: str):
        ...
        import json
        mapping_path = str(DEPLOY_OUTPUT_DIR / "doc_mapping.json")
